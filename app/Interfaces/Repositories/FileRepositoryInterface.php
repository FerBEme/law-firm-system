...
interface FileRepositoryInterface {
    // Busca un archivo por su ID, Devuelve:
    // - Objeto File si lo encuentra
    // - null si no existe
    public function findById(int $id): ?File;
    // Crea un nuevo archivo con los datos proporcionados, Devuelve el objeto File recién creado
    public function create(array $data): File;
    // Elimina un archivo existente, Devuelve:
