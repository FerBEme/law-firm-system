...
{
    // Método donde se registran los servicios e interfaces
    public function register(): void
    {
        // Cada vez que se inyecte CaseRepositoryInterface, se instanciará CaseRepository
        $this->app->bind(CaseRepositoryInterface::class, CaseRepository::class);

        // Cada vez que se inyecte FileRepositoryInterface, se instanciará FileRepository
        $this->app->bind(FileRepositoryInterface::class, FileRepository::class);

        // Cada vez que se inyecte PaymentRepositoryInterface, se instanciará PaymentRepository
